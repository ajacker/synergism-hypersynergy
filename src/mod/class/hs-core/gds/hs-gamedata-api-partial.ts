...
import { Player } from "../../../types/data-types/hs-player-savedata";
...
export abstract class HSGameDataAPIPartial extends HSModule {
    ...
    protected gameData: Player | undefined;
    ...
    async getForcedGameData(): Promise<Player | undefined> {
